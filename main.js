...
function loadTechnologies(technos) {
    ...
    fetch('https://us-central1-pwa-technos-spikoov.cloudfunctions.net/getTechnos')
        .then(response => {
            response.json()
                .then(technos => {
...
if(navigator.serviceWorker) {
    ...
    navigator.serviceWorker
        ...
        .then(registration =>{
            ...
            const publicKey = "BMi-_3xcF0Akn6aUTKXC3hOoQ47P51ykvzGu3ctDzaL3-Ta5567i5-fnRYgp4YAp9almiiGJLWWWTcf8n7sZZ-c";
